...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
		     ...
		     <h1>Powered by <a href="http://mobilegrows.com/" rel="external"><span>MobileGrows</span> </a>|<a href="http://www.dolcesalatousa.com/" rel="external"><span>DesktopSite</span> </a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<fieldset class="ui-grid-a" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-a"><a class="findcall ui-btn ui-icon-phone ui-btn-icon-left buttons-radius" href="tel:<?php echo $telephone ?>">Call US</a></div>
					...
					<div class="ui-block-b" id="findUS">
						<script>
							...
							if(/Android|webOS|Opera Mini/i.test(navigator.userAgent) ) {
								...
								dugme.setAttribute('class', "findcall ui-btn ui-icon-location ui-btn-icon-left buttons-radius");
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Chi siamo</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Il Menu</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">I nostri prodotti</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Media</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Galleria fotografica</a></div>
				</div>
			...
			<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-home">
						<ul id="menu-home">
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Home Page</a></li>
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">Chi siamo</a></li>
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">Il Menu</a></li>
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">I nostri prodotti</a></li>
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">Media</a></li>
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">Galleria fotografica</a></li>
